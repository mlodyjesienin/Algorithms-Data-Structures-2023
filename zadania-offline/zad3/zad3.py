...
#tych samych wyrazow. 
#zlozonosc obliczeniowa ciezko mi oszacowac, wydaje mi sie jednak ze nie jest
#kwadratowa wiec stawiam na O(N + nlogn) ale zalezy od tego jak dziala radix
#sort itd. 
...
def strong_string(T):
    ...
    if( maxi1 - mini1 > 100*n):
        ...
        altered_countingsort(T,n,math.floor(mini1),math.ceil(maxi1))
    i = 0
    j = 1 
    while j<n:
        a = len(T[i][0]) 
